...
function Todo() {
    ...
    return (
        <div className='container' style={{height:'100vh'}}>
             <h1 className='display-2 text-center'>VivaTech</h1>
            <h3 className='display-2 text-center'>To-do List</h3>
            <form className='d-flex mb-4' onSubmit={handleSubmit}>
                ...
                <button type='submit' className='btn btn-primary w-25'style={{backgroundColor: 'transparent'}}>Add Todo</button>
              <h6>**click checkbox for list 1</h6>
            </form>
            <div className='d-flex mb-4'>
            <div className='w-50 m-2'>
                <h3 className='display-6'>List 1</h3>
                ...
                <div>{todos.length? <button className='btn btn-info m-2' style={{backgroundColor: 'rosybrown'}} onClick={handleExport}>Export List 1 to Excel</button> : ''}
                
                </div>
            </div>

            <div className='w-50 m-2'>
                <h3 className='display-6'>List 2</h3>
                <ul className='list-group'>
                ...
                <div>
                    {todos2.length?
                <button className='btn btn-info m-2'style={{backgroundColor: 'rosybrown'}} onClick={handleExport2}>Export List 2 to Excel</button> : ''}
                </div>
            </div>
         </div>
